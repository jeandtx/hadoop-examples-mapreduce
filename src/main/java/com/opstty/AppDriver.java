...
public class AppDriver {
        public static void main(String argv[]) {
                ...
                try {
                        ...
                        programDriver.addClass("districtwithmosttrees", MostTreesDistrict.class,
                                        "A map/reduce program that displays the district with the most trees in the input files.");
